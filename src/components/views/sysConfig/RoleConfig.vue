<template>
  <el-row :gutter="16">
    <el-col :lg="{ span: 9 }" style="min-width: 300px;margin-bottom: 16px;">
      <el-card>
        <div style="overflow-x: auto;overflow-y: hidden">
          ...
          <el-tree ref="roleTree" v-loading="treeLoading"
                   :data="treeData"
    ...
    <el-col v-show="currRole.id&&currRole.id!==''" :lg="{ span: 15 }" style="margin-bottom: 16px;">
      <el-card>
        ...
        <el-tabs v-model="activeName">
          <el-tab-pane name="basicInfo">
            ...
            <el-form ref="editForm" v-loading="treeLoading" :model="editFormModel" :rules="ruleEditForm"
              ...
              <el-form-item :label="$t('forms.code')" prop="code">
                <el-autocomplete v-model="editFormModel.code" :disabled="treeLoading" :fetch-suggestions="querySearch"
          ...
          <el-tab-pane name="people">
            ...
            <el-transfer v-model="editFormModel.userIds" v-loading="treeLoading"
          ...
          <el-tab-pane name="menuList">
            ...
            <el-tree ref="menuTree" v-loading="treeLoading" :data="menuData"
                     :default-expanded-keys="editFormModel.menuIds"
                     :show-checkbox="true" node-key="id"/>
          </el-tab-pane>
          <el-tab-pane name="moduleFuncList">
            ...
            <el-tree ref="moduleFuncTree" v-loading="treeLoading" :data="moduleFuncData"
                     :default-expanded-keys="editFormModel.moduleFuncIds"
                     :show-checkbox="true" node-key="id"/>
          </el-tab-pane>
        </el-tabs>
...
<script>
import {findCheckedTreeNode, getTreeFullPathTitle, processTreeNode, sortTreeNodes} from '@/libs/tools'
